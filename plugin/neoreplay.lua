...
vim.api.nvim_create_user_command('NeoReplayHeatmapToggle', neoreplay.heatmap_toggle, {})
vim.api.nvim_create_user_command('NeoReplayDashboard', neoreplay.dashboard, {})
vim.api.nvim_create_user_command('NeoReplayDashboardToggle', neoreplay.dashboard_toggle, {})
vim.api.nvim_create_user_command('NeoReplayBookmark', function(opts)
  neoreplay.bookmark(opts.args ~= "" and opts.args or nil)
end, { nargs = '?' })
vim.api.nvim_create_user_command('NeoReplayBookmarks', neoreplay.bookmark_list, {})
vim.api.nvim_create_user_command('NeoReplayBookmarkClear', neoreplay.bookmark_clear, {})
vim.api.nvim_create_user_command('NeoReplayHeatmapClear', neoreplay.heatmap_clear, {})

vim.api.nvim_create_user_command('NeoReplayExportShorts', function(opts)
  neoreplay.export_shorts(opts.args ~= "" and opts.args or nil)
end, { nargs = '?' })

vim.api.nvim_create_user_command('NeoReplayExportReels', function(opts)
  neoreplay.export_reels(opts.args ~= "" and opts.args or nil)
end, { nargs = '?' })

vim.api.nvim_create_user_command('NeoReplayExportTikTok', function(opts)
  neoreplay.export_tiktok(opts.args ~= "" and opts.args or nil)
end, { nargs = '?' })

vim.api.nvim_create_user_command('NeoReplayExportTwitter', function(opts)
  neoreplay.export_twitter(opts.args ~= "" and opts.args or nil)
end, { nargs = '?' })
